...
<head>
  ...
  <link rel="stylesheet" href="<?= ASSERT_PATH ?>assets/css/meeting/calendar.css">
...
<body>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <form class="row g-3 needs-validation" id="timeLogForm" method="POST" novalidate>
                    ...
                    <button type="submit" id="timelogbutton" class="btn btn-primary me-1 mb-2">Log Time</button>
                  </form>
          ...
          <div id="scheduleMeetingForm">
            <form class="row g-3 needs-validation" id="meetingForm" novalidate>
              ...
              <div class="col-md-6" id="epic-container" style="display: none;">
                ...
                <input type="text" class="form-control" id="epicdropdown" name="r_epic_id" data-bs-toggle="dropdown"
              ...
              <div class="col-md-6" id="userstory-container" style="display: none;">
                <label for="userstory" class="form-label">User stories</label>
                <input type="text" class="form-control" id="userstory" name="r_user_story_id" data-bs-toggle="dropdown"
                  aria-expanded="false" placeholder="Choose the userstory" readonly>
              ...
              <div class="col-md-6" id="sprint_start_date_container" style="display: none;">
                ...
                <input type="text" class="form-control mb-3 flatpickr-no-config flatpickr-input" id="sprint_start_date"
                  name="sprint_start_date" accept="" placeholder="Select recurrence start date" required>
              ...
              <div class="col-md-6" id="sprint_end_date_container" style="display: none;">
                ...
                <input type="text" class="form-control mb-3 flatpickr-no-config flatpickr-input" id="sprint_end_date"
                  name="sprint_end_date" accept="" placeholder="Select recurrence end date" required>
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  <input type="number" class="form-control" id="meeting_duration_hours" name="meeting_duration_hours"
              ...
              <div class="col-md-3" id="meeting_start_date_container">
                ...
                <input type="text" class="form-control mb-3 flatpickr-no-config flatpickr-input" id="meeting_start_date"
                  name="meeting_start_date" accept="" placeholder="Select date" required>
              ...
              <div class="col-md-3" id="meeting_end_date_container">
                ...
                <input type="text" class="form-control mb-3 flatpickr-no-config flatpickr-input" id="meeting_end_date"
                  name="meeting_end_date" accept="" placeholder="Select date" required>
                <div class="invalid-feedback">Please choose a meeting date.</div>
              </div>
              ...
              <div class="col-md-6">
                <label for="meeting_team" class="form-label">
                  <div class="btn-group" role="group" aria-label="Invite options">
                    <button type="button" class="cls-add-members" onclick="showAddTeamMember()">Add team member</button>
                    <button type="button" class="cls-add-members" onclick="showInviteGroup()">/ Invite group</button>
                  </div>
                </label>
                <div class="dropdown">
                  <div id="addTeamMemberSection" style="display: none;">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" id="teamInput" placeholder="Search team members"
                        onkeyup="filterEmails()" autocomplete="off">
                    </div>
                    <div id="emailDropdown" class="dropdown-menu">
                    </div>
                  </div>
                  <div id="inviteGroupSection" style="display: none;">
                    <input type="text" class="form-control" id="addgroup" name="addgroup" data-bs-toggle="dropdown"
                      aria-expanded="false" placeholder="Choose the Group" readonly>
              ...
              <div id="updateAsSeriesDiv" style="display: none;">
                <div class="form-check" style="padding-left : 340px;">
                  <input class="form-check-input" type="checkbox" id="updateAsSeries" name="updateAsSeries" value="1">
          ...
          <div id="helpdetails" class="helpdetails">
            ...
            <div>
              <span class="badge col-md-2" style="background-color: #d85733;"><b>Ongoing</b></span> This colour
              indicates
              ongoing meetings.
              <br>
              <span class="badge col-md-2" style="background-color: #63a4ff;"><b>Upcoming</b></span> This colour
              indicates
              upcoming meetings.
              <br>
              <span class="badge col-md-2" style="background-color: #34be34;"><b>Completed</b></span> This colour
              indicates completed meetings.
              <br>
              <span class="badge col-md-2" style="background-color: #585858;"><b>Cancelled</b></span> This colour
              indicates cancelled meetings.
              <br>
              <span class="badge col-md-2" style="background-color: #fc1f1f;"><b>Need to log</b></span> This colour
              indicates to Log the meeting duration for attendees.
            </div>
            <br>
            ...
            <div>
              ...
              upcoming sprints.
              <br>
              <span class="badge col-md-2" style="background-color: #F77B00;"><b>On hold</b></span> This colour
              indicates
              on hold sprints.
              <br>
              <span class="badge col-md-2" style="background-color: #34be34;"><b>Completed</b></span> This colour
              indicates completed sprints.
            </div>
          </div>
              ...
              <div class="col-md-12" id="memberDetails">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <thead>
                      <tr>
                        <th class="cls-membersth"><input type="checkbox" id="selectAllMembers"> Select all</th>
  ...
  <script src='<?= ASSERT_PATH ?>assets/js/meeting/calendar.js'></script>
</body>
